...
public class Complementary {
	...
	public Complementary(int confirmacaoTeste) {
		this.confirmacao = confirmacaoTeste;
	}

	public Complementary(int confirmacaoTeste, int confirmacaoSaidaBalconista, int confirmacaoSaidaCaixa,
	...
	public int GeneralConfirmation(int estados) {
	...
	public int ConfirmationClerk(int estados) {
	...
	public int ConfirmationBox(int estados) {
	...
	public int ConfirmationClient(int estados) {
		System.out
	...
	public int ConfirmationMedicament(int estados) {
	...
	public int menuHelp(int estados) {
		System.out
