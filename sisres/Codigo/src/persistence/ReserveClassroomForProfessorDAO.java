...
public class ReserveClassroomForProfessorDAO extends DAO{
	...
	//Singleton
		private static ReserveClassroomForProfessorDAO instance;
		private ReserveClassroomForProfessorDAO(){
		}
		public static ReserveClassroomForProfessorDAO getReserveClassroomForProfessor(){
			if(instance == null)
				instance = new ReserveClassroomForProfessorDAO();
			return instance;
		}
		//Querys de Reuso
			...
			private String atibutes_value_reserva_sala_professor(ReserveClassroomForProfessor r){
			...
			private String delete_from_aluno(ReserveClassroomForProfessor r){
				return "DELETE FROM reserva_sala_aluno WHERE " +
						"hora = \"" + r.getHour() + "\" and " +
						"data = \"" + r.getDate() +  "\" ;";
			}
			
			private String update(ReserveClassroomForProfessor r, ReserveClassroomForProfessor r2){
				return "UPDATE reserva_sala_professor SET " + 
						this.atibutes_value_reserva_sala_professor(r2) +
						this.where_reserva_sala_professor(r) + " ;";
			}
			
	public void incluir(ReserveClassroomForProfessor r) throws ReserveException, SQLException {
		if(r == null)
	...
	public void updateReserveClassroomForProfessor(ReserveClassroomForProfessor r, ReserveClassroomForProfessor r_new) throws ReserveException, SQLException {
		if(r == null)
			throw new ReserveException(NULA);
		else if(r_new == null)
			throw new ReserveException(NULA);
	...
	public void delete(ReserveClassroomForProfessor r) throws ReserveException, SQLException {
		if(r == null)
			throw new ReserveException(NULA);
		else if(!this.reservainDB(r))
			throw new ReserveException(RESERVA_INEXISTENTE);
	...
	public Vector<ReserveClassroomForProfessor> searchAll() throws SQLException, ClientException, PatrimonyException, ReserveException{
	...
	@SuppressWarnings("unchecked")
	public Vector<ReserveClassroomForProfessor> searchForDate(String data) throws SQLException, ClientException, PatrimonyException, ReserveException{
		return super.buscar("SELECT * FROM reserva_sala_professor " +
				"INNER JOIN sala ON sala.id_sala = reserva_sala_professor.id_sala " +
				"INNER JOIN professor ON professor.id_professor = reserva_sala_professor.id_professor" +
	...
	protected Object fetch(ResultSet rs) throws SQLException, ClientException, PatrimonyException, ReserveException {
		...
		ReserveClassroomForProfessor r = new ReserveClassroomForProfessor(rs.getString("data"),rs.getString("hora"),
