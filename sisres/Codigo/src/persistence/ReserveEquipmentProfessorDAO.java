...
public class ReserveEquipmentProfessorDAO extends DAO {
    ...
    // Singleton
    private static ReserveEquipmentProfessorDAO instance;

    private ReserveEquipmentProfessorDAO() {
    }

    public static ReserveEquipmentProfessorDAO getReserve() {
        if (instance == null)
            instance = new ReserveEquipmentProfessorDAO();
        return instance;
    }
    ...
    private String where_reserva_equipamento_professor(ReserveEquipmentProfessor r) {
        return " WHERE " + "id_professor = ( " + select_id_professor(r.getProfessor()) + " ) and " + "id_equipamento = ( "
                + select_id_equipamento(r.getEquipment()) + " ) and " + "hora = \"" + r.getHour() + "\" and " + "data = \""
                + r.getDate();
    }

    private String values_reserva_equipamento_professor(ReserveEquipmentProfessor r) {
        return "( " + select_id_professor(r.getProfessor()) + " ), " + "( " + select_id_equipamento(r.getEquipment()) + " ), "
                + "\"" + r.getHour() + "\", " + "\"" + r.getDate();
    }

    private String atributes_value_reserva_equipamento_professor(ReserveEquipmentProfessor r) {
        return "id_professor = ( " + select_id_professor(r.getProfessor()) + " ), " + "id_equipamento = ( "
                + select_id_equipamento(r.getEquipment()) + " ), " + "hora = \"" + r.getHour() + "\", " + "data = \""
                + r.getDate();
    }
    ...
    private String update(ReserveEquipmentProfessor r, ReserveEquipmentProfessor r2) {
    ...
    private String delete_from_aluno(ReserveEquipmentProfessor r) {
        return "DELETE FROM reserva_equipamento_aluno WHERE " + "hora = \"" + r.getHour() + "\" and " + "data = \"" + r.getDate()
                + " ;";
    }

    public void include(ReserveEquipmentProfessor r) throws ReserveException, SQLException {
        if (r == null)
        ...
        else if (this.equipamentoinReservaDB(r.getEquipment(), r.getDate(), r.getHour()))
            throw new ReserveException(EQUIPAMENTO_INDISPONIVEL);
        else if (this.professorinReservaDB(r.getProfessor(), r.getDate(), r.getHour()))
    ...
    public void updateReserve(ReserveEquipmentProfessor r, ReserveEquipmentProfessor r_new) throws ReserveException, SQLException {
        if (r == null)
            throw new ReserveException(NULA);
        else if (r_new == null)
            throw new ReserveException(NULA);
            ...
            if (this.professorinReservaDB(r_new.getProfessor(), r_new.getDate(), r_new.getHour()))
                throw new ReserveException(RESERVA_EXISTENTE);// Perguntar pro
                                                              // Matheus
            else if (this.equipamentoinReservaDB(r_new.getEquipment(), r_new.getDate(), r_new.getHour()))
                throw new ReserveException(EQUIPAMENTO_INDISPONIVEL);
    ...
    public void delete(ReserveEquipmentProfessor r) throws ReserveException, SQLException {
        if (r == null)
            throw new ReserveException(NULA);
        else if (!this.reservainDB(r))
            throw new ReserveException(RESERVA_INEXISTENTE);
    ...
    @SuppressWarnings("unchecked") public Vector<Object> searchAll() throws SQLException, ClientException, PatrimonyException,
            ReserveException {
    ...
    @SuppressWarnings("unchecked") public Vector<ReserveEquipmentProfessor> searchForMonth(int mes) throws SQLException,
            ClientException, PatrimonyException, ReserveException {
        Vector<ReserveEquipmentProfessor> reservas_prof_mes = super.buscar("SELECT * FROM reserva_equipamento_professor "
    ...
    @SuppressWarnings("unchecked") public Vector<ReserveEquipmentProfessor> searchForHour(String hora) throws SQLException,
            ClientException, PatrimonyException, ReserveException {
    ...
    @Override protected Object fetch(ResultSet rs) throws SQLException, ClientException, PatrimonyException, ReserveException {
        ...
        ReserveEquipmentProfessor r = new ReserveEquipmentProfessor(rs.getString("data"), rs.getString("hora"), s, p);
    ...
    private boolean reservainDB(ReserveEquipmentProfessor r) throws SQLException {
        return super.inDBGeneric("SELECT * FROM reserva_equipamento_professor WHERE "
                ...
                + "\" and " + "hora = \"" + r.getHour() + "\" and " + "data = \"" + r.getDate() + ";");
    }
