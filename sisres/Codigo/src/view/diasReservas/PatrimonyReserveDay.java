 ...
 * @author Parley
 */
public abstract class PatrimonyReserveDay extends javax.swing.JDialog {
    public PatrimonyReserveDay(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        
        initComponents();
    }

    protected abstract void viewAction(String data);
    ...
    private void initComponents() {
        ...
        viewButton.setName("VisualizarButton"); // NOI18N
        ...
        layout.createSequentialGroup()
        	  ...
        	  .addComponent(viewButton).addContainerGap()));
